...
import com.aslihanhasar.medicaltourismapp.dto.request.RouteSaveRequest;
import com.aslihanhasar.medicaltourismapp.dto.response.AirportSaveResponse;
import com.aslihanhasar.medicaltourismapp.dto.response.RouteSaveResponse;
import com.aslihanhasar.medicaltourismapp.dto.response.RouteSearchResponse;
import com.aslihanhasar.medicaltourismapp.entity.Airport;
import com.aslihanhasar.medicaltourismapp.entity.Route;
import com.aslihanhasar.medicaltourismapp.exception.RouteAlreadySaveException;
import com.aslihanhasar.medicaltourismapp.exception.RouteNotFoundException;
import com.aslihanhasar.medicaltourismapp.exception.RouteValidationException;
import com.aslihanhasar.medicaltourismapp.repository.RouteRepository;
...
public class RouteService {
    ...
    private List<Route> findRoutesByDepartureAndArrival(String departureKey, String arrivalKey) {
        return routeRepository.findByDepartureAirport_CityNameIgnoreCaseOrArrivalAirport_CityNameIgnoreCase(
    ...
    private void validateRouteLocations(Airport departureAirport, Airport arrivalAirport) {
        String departureLocation = departureAirport.getCity().getName();
        String arrivalLocation = arrivalAirport.getCity().getName();
