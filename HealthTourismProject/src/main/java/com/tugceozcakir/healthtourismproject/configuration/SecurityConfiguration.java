package com.tugceozcakir.healthtourismproject.configuration;

import com.tugceozcakir.healthtourismproject.database.repository.UserRepository;
import com.tugceozcakir.healthtourismproject.util.security.JWTFilter;
import com.tugceozcakir.healthtourismproject.util.security.SecurityService;
...
public class SecurityConfiguration {
    ...
    private static final String[] USER_AUTH_WHITELIST = {
            ...
            "/airplane/select/**",
            "/doctors/select/**",
            "/doctors/get-all-filter",
            "/room/get-all-filter",
            "/airplane/get-all-filter",
