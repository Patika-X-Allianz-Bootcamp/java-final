...
import com.burakcanciftci.healthtourism.service.UserService;
import com.burakcanciftci.healthtourism.util.security.JWTUtil;
...
public class AuthorizationController {
    ...
    public ResponseEntity<Boolean> loginHandler(@RequestBody UserRegistrationDTO userRequestDTO) {
        userService.saveUserByRole(userRequestDTO);
